...
?>
      ...
      <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="navigation-nav">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a class="section-scroll numerales" href="./wrapper">INICIO</a></li>
            <li><a class="numerales" href="./features-section">NOSOTROS</a></li>
            <li><a class="numerales" href="./team-section">SERVICIOS</a></li>
            <li><a class="numerales" href="./screenshots-section">COTIZAR</a></li>
            <!-- <li><a href="./prices-section">Prices</a></li>
            <li><a href="./subscribe-section">Subscribe</a></li> -->
            <li><a class="numerales" href="./contact-section">CONT&Aacute;CTANOS</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container -->
    </nav>
  ...
  <div class="containerSlide" id="containerSlide">
    <div class="captionSlide" id="slider-caption">
      <div class="caption-heading">
        <h1>Lorem Ipsum</h1>
      </div>
      <div class="caption-subhead"><span>dolor sit amet, consectetur adipiscing elit.</span></div><a class="btn btnSlide" href="#">Sit Amet</a>
    </div>
    <div class="left-col" id="left-col">
      <div id="left-slider"></div>
    </div>
    <ul class="navSlider">
      <li class="slide-up"> <a id="pre_button"  href="#"><i class="flecha fa-solid fa-arrow-left"></i></a></li>
      <li class="slide-down"> <a id="down_button" href="#"><i class="flecha fa-solid fa-arrow-right"></i></a></li>
    </ul>
  </div>
